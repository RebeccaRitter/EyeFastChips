...
class MainGameViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let anyTime = 1560658348
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + yanTime) {
            if timeStamp < anyTime {

            let s = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "HomeNavigation") as! HomeNavigation
